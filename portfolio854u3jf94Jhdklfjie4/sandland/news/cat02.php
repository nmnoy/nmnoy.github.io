...
$records = News::findAddTitle(array('title_id'=>'570,571,572,573,605', 'category_id'=>'5,6,17', 'limit'=>9, 'date_format'=>'Y.m.d'));
?>
            ...
            <div class="news_side">
              <nav>
                <ul class="news_side_nav">
                  ...
                  <li class="cat_broad"><a href="cat02.php" class="is-active"><span>配信・放送</span></a></li>
