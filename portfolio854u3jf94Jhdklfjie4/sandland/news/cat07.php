...
$records = News::findAddTitle(array('title_id'=>'570,571,572,573,605', 'category_id'=>'2,7,15,18,19,21', 'limit'=>9, 'date_format'=>'Y.m.d'));
?>
            ...
            <div class="news_side">
              <nav>
                <ul class="news_side_nav">
                  ...
                  <li class="cat_other"><a href="cat07.php" class="is-active"><span>その他</span></a></li>
                </ul>
              </nav>
            </div>
