...
$records = News::findAddTitle(array('title_id'=>'570,571,572,573,605', 'category_id'=>'', 'limit'=>9, 'date_format'=>'Y.m.d'));
?>
            ...
            <div class="news_side">
              <nav>
                <ul class="news_side_nav">
                  <li class="cat_all"><a href="./" class="is-active"><span>すべて</span></a></li>
